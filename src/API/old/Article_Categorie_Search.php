...
//WHERE article.designation LIKE %$search_text% AND article.id_categorie=categorie.id_categorie
 ...
 WHERE article.designation LIKE  '%$search_text%'AND article.id_categorie=$id_categorie  AND article.id_categorie=categorie.id_categorie
