...
export default class DetailsArticle extends React.Component {
  ...
  //  const image='"'.concat(item.img,'"')
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.infoRecipeContainer2}>
          <Text style={styles.infoRecipeName}>{item.designation}</Text>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoRecipe}>{item.prix} MRU / {item.unit}</Text>
          </View>
